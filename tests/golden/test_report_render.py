...
def test_report_contains_required_sections() -> None:
    scored = {
        ...
        "findings": [{"category": "security_posture", "severity": "high", "statement": "Probable hardcoded secret detected.", "detector_source": "common"}],
        "scoring": {
            "overall_score": 55,
            "verdict": "fail",
            "score_confidence": "medium",
            "category_scores": [{"category": "security_posture", "applicable": True, "score": 2, "max_score": 20, "summary": "x"}],
        },
